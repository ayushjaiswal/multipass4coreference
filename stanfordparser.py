...
def startJvm():
    import os
    #original os environment
    #os.environ.setdefault("STANFORD_PARSER_HOME", "stanford-parser-python-r22186/3rdParty/stanford-parser/stanford-parser-2010-08-20")
